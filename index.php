            ...
            <div class="row">
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".1s">
                  ...
                  <h3 class="item_title text-uppercase mb-0">Saveurs exceptionnelle</h3>
                </div>
              </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".2s">
                  ...
                  <h3 class="item_title text-uppercase mb-0">Qualité élévé</h3>
                </div>
              </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".3s">
                  ...
                  <h3 class="item_title text-uppercase mb-0">pure grains</h3>
                </div>
              </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".4s">
                  ...
                  <h3 class="item_title text-uppercase mb-0">Machines de qualité</h3>
                </div>
              </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".5s">
                  ...
                  <h3 class="item_title text-uppercase mb-0">vaste parfums</h3>
                </div>
              </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".6s">
                  ...
                  <h3 class="item_title text-uppercase mb-0">excellent grains</h3>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="contact_form bg_white wow fadeInUp" data-wow-delay=".1s">
              <div class="main_contact_info_wrap">
                ...
                <div class="contact_info_item">
                  ...
                  <div class="item_content">
                    <h3 class="item_title text-uppercase">Notre localisation</h3>
                ...
                <div class="contact_info_item">
                  ...
                  <div class="item_content">
                    <h3 class="item_title text-uppercase">Numéro de telephone</h3>
                    <p>(+225) 07984888</p>
                  </div>
                </div>
              </div>
