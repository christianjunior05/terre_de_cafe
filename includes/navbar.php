              ...
              <div class="col-lg-2 col-md-6 col-6">
                <div class="brand_logo">
                  <a class="brand_link" href="index.php">
                    <img src="assets/images/logo/logo.png" srcset="assets/images/logo/logo.png 2x" alt="logo_not_found" width="100px" height="50px">
                  </a>
                </div>
              </div>
                ...
                <nav class="main_menu navbar navbar-expand-lg">
                  ...
                  <div class="main_menu_inner collapse navbar-collapse" id="main_menu_dropdown">
                    <ul class="main_menu_list ul_li">
                      <li>
                        <a class="nav-link" href="index.php" id="home_submenu" role="button" >
                          Accueil
                        </a>
                      </li>
                      <li class="dropdown">
